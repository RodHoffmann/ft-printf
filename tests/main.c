...
/*   Updated: 2024/07/02 17:15:12 by rohoffma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	test13_ft = ft_printf("ft_printf: testing for 0 hex(low): %x\n", 0);
	test13 = printf("or_printf: testing for 0 hex(low): %x\n", 0);
	return_test(test13_ft, test13);
